    ...
    <li><a href="login.html">உள்நுழைவு</a></li>
      ...
      <div class="container" style="display: flex; justify-content: center; align-items: center; ">     
          ...
          <div class="left-side" id="leftContent">
              <h2 style="text-align: center; font-weight: bold;"> தொழில்நுட்பம் சார்ந்த பொதுஅறிவு</h2>
...
$sql = "SELECT id, category, title, image_path, content FROM uploads WHERE category = 'தொழில்'";

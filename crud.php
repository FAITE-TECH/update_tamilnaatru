...
<body>
  ...
  <ul>
    ...
    <div class="left-side" id="leftContent">
        <h2 style="text-align: center; font-weight: bold;">ஆக்கங்கள்</h2>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<div class="update-box" style="border:none; display: flex; align-items: center;" data-id="' . htmlspecialchars($row['id']) . '">
                        ...
                        <div style="display: flex; gap: 10px;">
                            ...
                            <form action="edit_article.php" method="GET" style="margin: 0;">
                                <input type="hidden" name="id" value="' . htmlspecialchars($row['id']) . '">
                                <button type="submit" class="cta-btn" style="background-color: #3498db;">Edit</button>
                            </form>
                        </div>
                      </div>';
            }

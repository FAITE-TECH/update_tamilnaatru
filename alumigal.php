    ...
    <div class="hero_area">
      ...
      <div class="container" style="display: flex; justify-content: center; align-items: center; ">     
          ...
          <div class="left-side" id="leftContent">
              <h2 style="text-align: center; font-weight: bold;">ஆளுமை சார்ந்த கட்டுரைகள்</h2>
...
$sql = "SELECT id, category, title, image_path, content FROM uploads WHERE category = 'ஆளுமை' ";
